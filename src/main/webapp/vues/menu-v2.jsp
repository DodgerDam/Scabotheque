...
<div class="scroll-stop navbar" id="navbar">
	...
	<div class="dropdown 
	    ...
	    <a href="#"> 
			<svg class="icon" ><use xlink:href="<c:url value="/resources/images/icones.svg#card-v2"/>"></use></svg>
	    ...
	    <div id="drop" class="scroll-stop dropdown-content">
	      	<a href="${urlListe}" class="navbar first-element <c:if test = "${pageType == 'LIST_ADHERENT'}"> active </c:if>">
	   		...
	   		<a href="${urlAdd}">
		   		<svg class="icon" ><use xlink:href="<c:url value="/resources/images/icones.svg#card-add"/>"></use></svg>
	...
	<a <c:if test = "${pageType == 'GESTION_FOURNISSEUR'}"> class="active"</c:if> href="${url}">
		<svg class="icon" ><use xlink:href="<c:url value="/resources/images/icones.svg#supply"/>"></use></svg>
	...
	<div class="dropdown">
	    <a href="#" class="navbar"> 
			<svg class="icon" ><use xlink:href="<c:url value="/resources/images/icones.svg#excel"/>"></use></svg>
	    ...
	    <div class="scroll-stop dropdown-content">
	      	<a class="navbar first-element">
	   		...
	   		<a href=<c:url value="http://srvoutils/ScaboisWiki/doku.php?id=start"/> target="_blank">
				<svg class="icon" ><use xlink:href="<c:url value="/resources/images/icones.svg#wiki"/>"></use></svg>
				<spring:message code="menu.wiki"/>
			</a>
			<a href=<c:url value="http://preprod-scabois.orcab.net"/> target="_blank">
				<svg class="icon"><use xlink:href="<c:url value="/resources/images/icones.svg#modus"/>"></use></svg>
				<spring:message code="menu.extranet"/>
			</a>
			<a href=<c:url value="http://adherents.scabois.fr"/> target="_blank">
				<svg class="icon"><use xlink:href="<c:url value="/resources/images/icones.svg#book"/>"></use></svg>
				<spring:message code="menu.openWeb"/>
			</a>
			<a href=<c:url value="https://questionnaire.dfiweb.net/"/> target="_blank">
				<svg class="icon"><use xlink:href="<c:url value="/resources/images/icones.svg#questionnaire"/>"></use></svg>
			...
			<a href=<c:url value="https://www.facebook.com/ArtipoleDoleChoisey/"/> target="_blank">
				<svg class="icon"><use xlink:href="<c:url value="/resources/images/icones.svg#facebook"/>"></use></svg>
	...
	<c:url value="/parametrage" var="urlParamTypeContact"><c:param name="type" value="TypeContact"/></c:url>
	<div class="dropdown">
	    <a class="navbar 
	    ...
	    <div class="scroll-stop dropdown-content">
			...
			<a href="${urlParamTypeContact}">
				<svg class="icon" ><use xlink:href="<c:url value="/resources/images/icones.svg#supply"/>"></use></svg>
				<spring:message code="menu.paramTypeContact"/>
			</a>
